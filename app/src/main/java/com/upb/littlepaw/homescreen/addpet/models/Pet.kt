...
data class Pet (var name: String,var birthday: String,var breed: String,var description: String,var gender: PetGender, var type:PetType,var image: ByteArray, var location:String)
